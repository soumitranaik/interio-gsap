...
const Contact = () => {
  return (
    <div id="contact" className="my-20 min-h-96 w-screen  px-10">
      <div className="relative rounded-lg bg-cyan-500 py-24 text-blue-50 sm:overflow-hidden">
